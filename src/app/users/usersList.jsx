...
const Example = () => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                accessorKey: 'name', // Access the 'firstName' property within the 'name' object
                header: ' Name',
                size: 150,
            },
            {
                accessorKey: 'category', // Access the 'category' property directly
                header: 'Category',
                size: 150,
            },
            {
            ...
            {
                accessorKey: 'createdAt', // Access the 'createdAt' property directly
                header: 'Created At',
                size: 150,
            },
            {
                accessorKey: 'updatedAt', // Access the 'updatedAt' property directly
                header: 'Updated At',
                size: 150,
            },
            {
