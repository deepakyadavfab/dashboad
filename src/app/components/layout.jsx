...
import { PeopleAlt, PeopleAltTwoTone, QueryStats, SpaceDashboard, Work } from '@mui/icons-material';
...
function Layout(props) {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
        {['Dashboad', 'Analytics', 'Users', 'Projects'].map((text, index) => (
